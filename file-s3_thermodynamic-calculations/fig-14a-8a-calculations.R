...
# function in CHNOSZ. Finally, the saturation of quartz is calculated. This program is modified from 
# Leung et al. (2024), with a minor modification of having the legend displayed in the inset figure.
...
for (x in 1:2){ # calculate two diagrams, one zoomed out (Fig. 2a) and one zoomed in (Fig. 2b)
  ...
  legend1 <- lex(TP, SP)
    ...
    legend("bottomright", legend1, bg = "white", cex = 1.0,y.intersp = 1.5, text.width = xspacing)
